...
namespace WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddDbContext<ImageContext>(options => options.UseSqlServer(Configuration.GetConnectionString("mysqlConnection")));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(
                    name: "download",
                    template: "{controller=Page}/{action=Download}/{imagePath?}");
                routes.MapRoute(
                    name: "viewPage",
                    template: "{controller=Page}/{action=ViewPage}/{category?}");
                routes.MapRoute(
                    name: "default",
